...
const WORKBENCH_FILES = new Map([
  ...
  ["/workbench/connections/", { url: new URL("../workbench/connections.html", import.meta.url), contentType: "text/html; charset=utf-8" }],
  ["/workbench/effect-modules", { url: new URL("../workbench/effect-modules.html", import.meta.url), contentType: "text/html; charset=utf-8" }],
  ["/workbench/effect-modules/", { url: new URL("../workbench/effect-modules.html", import.meta.url), contentType: "text/html; charset=utf-8" }],
  ...
  ["/effect-modules.js", { url: new URL("../workbench/effect-modules.js", import.meta.url), contentType: "text/javascript; charset=utf-8" }],
