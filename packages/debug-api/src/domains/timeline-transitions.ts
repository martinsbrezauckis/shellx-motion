...
function mutateLayer<T extends { layer: MotionLayer }>(pkg: MotionPackage, layerId: string, mutate: (layer: MotionLayer) => T): T & { motion: MotionDocument } {
