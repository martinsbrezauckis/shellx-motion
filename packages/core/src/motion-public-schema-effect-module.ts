import { GPU_EFFECT_MODULE_RENDERER_ABI, MOTION_AFTERIMAGE_STACK_INTRINSIC, MOTION_AFTERIMAGE_STACK_PARAMETER_SCHEMA, MOTION_EFFECT_MODULE_REF_SCHEMA } from "./effect-module";
...
export function buildEffectModuleDefinitions(): Record<string, unknown> {
  return {
    effectModule: {
      ...
      properties: { schema: { const: MOTION_EFFECT_MODULE_REF_SCHEMA }, moduleId: { type: "string", pattern: "^[a-z][a-z0-9]*(?:[.-][a-z0-9]+){1,7}$", maxLength: 128 }, version: { type: "string", pattern: "^(?:0|[1-9][0-9]*)\\.(?:0|[1-9][0-9]*)\\.(?:0|[1-9][0-9]*)(?:-(?:(?:0|[1-9][0-9]*)|[0-9A-Za-z-]*[A-Za-z-][0-9A-Za-z-]*)(?:\\.(?:(?:0|[1-9][0-9]*)|[0-9A-Za-z-]*[A-Za-z-][0-9A-Za-z-]*))*)?$" }, parameters: { $ref: "#/$defs/effectModuleParameters" } }
    },
