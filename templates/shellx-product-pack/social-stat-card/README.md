# ShellX Social Stat Card

Square-first social promo card for platform, release, and product status metrics. It gives the catalog a distinct social-stat visual family and vertical/social output bounds.

## Typography

Text layers render in Inter. The package bundles the Latin-subset Inter weights
it actually selects (800 ExtraBold, 900 Black) under `assets/fonts/`, so the template
